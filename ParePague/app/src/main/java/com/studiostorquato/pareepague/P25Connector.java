...
import com.studiostorquato.pareepague.util.StringUtil;
...
public class P25Connector {
    ...
    public void connect(BluetoothDevice device) throws P25ConnectionException {
        if (mIsConnecting && mConnectTask != null) {
            throw new P25ConnectionException("Realizando conexão");
        }

        if (mSocket != null) {
            throw new P25ConnectionException("Conexão já estabelecida");
        }
    ...
    public void disconnect() throws P25ConnectionException {
        if (mSocket == null) {
            throw new P25ConnectionException("A impressora não esta conectada");
        }
    ...
    public void cancel() throws P25ConnectionException {
        if (mIsConnecting && mConnectTask != null) {
            ...
            throw new P25ConnectionException("Sem conexões no momento");
        }
    }

    public void sendData(byte[] msg) throws P25ConnectionException {
        if (mSocket == null) {
            throw new P25ConnectionException("A impressora não esta conectada, tente conectar primeiro");
        }
